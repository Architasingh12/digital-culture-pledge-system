                ...
                <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                        ...
                        <div>
                            ...
                            />
                            {errors.name && <p className="text-red-300 text-xs mt-1.5">{errors.name.message}</p>}
                        </div>
                        ...
                        <div>
                            <label className="block text-blue-100 text-sm font-medium mb-1.5">
                                Designation <span className="text-blue-300/50">(optional)</span>
                            </label>
                            <input
                        ...
                        <div>
                            ...
                            {passwordValue && strength && (
                                <div className="mt-2">
                                    ...
                                    <p className={`text-xs mt-1 ${strength.label === 'Weak' ? 'text-red-300' : strength.label === 'Fair' ? 'text-yellow-300' : 'text-green-300'}`}>
                        ...
                        {/* Confirm Password */}
                        <div>
                            <label className="block text-blue-100 text-sm font-medium mb-1.5">Confirm Password</label>
                            <div className="relative">
                                <input
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-blue-200/60 text-sm">
                            ...
                            <Link to="/login" className="text-blue-300 hover:text-white underline transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
